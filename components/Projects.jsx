      ...
      <div className="projects-container">
        ...
        <div className="projects-grid">
            <div className="project-card">
              ...
              <p>
I played a pivotal role in crafting a cutting-edge e-commerce landscape for NS, utilizing CommerceTools and hosted on AWS. 
My responsibilities centered around pinpointing user requirements, effectively communicating with stakeholders, and actively contributing to the collaborative effort in devising a seamless migration strategy. </p>
            </div>
